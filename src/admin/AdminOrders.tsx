      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-amber-200/60 pb-6">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-rose-50 border border-rose-200 hover:bg-rose-100 text-rose-700 font-bold text-xs shadow-sm disabled:opacity-50"
          >
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5">
                  ...
                  <div className="flex items-center gap-3">
                    <span
                      className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold border ${STATUS_CONFIG[order.status].color}`}
                    >
                    ...
                    <select
                      ...
                      className="text-xs font-bold border border-amber-200 rounded-xl px-3 py-2 bg-[#FAF8F3] focus:outline-none focus:ring-2 focus:ring-amber-500/40 disabled:opacity-50"
                    >
