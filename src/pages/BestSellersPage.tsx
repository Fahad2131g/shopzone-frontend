...
import { Loader2, Heart, ShoppingBag, Star, Flame } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="mb-8 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-black tracking-tight text-neutral-900">Best Sellers</h1>
          <p className="text-xs text-neutral-500 font-medium">Our most popular picks, loved by customers</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white rounded-3xl border border-neutral-200 p-8">
          <p className="text-sm font-semibold text-neutral-600">No best sellers marked yet — check back soon!</p>
        </div>
      ) : (
